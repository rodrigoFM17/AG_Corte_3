...
class Subject:
    ...
    def generate_images(self, folder="laminas"):
        """Genera imágenes de la distribución de piezas en cada lámina."""
        ...
        for i, plate in enumerate(self.plates_used):
            ...
            for piece in plate:
                ...
                ax.add_patch(rect)
                ax.text(piece.x + piece.width / 2, self.plate_height - piece.y - piece.height / 2,
                        f"{piece.width}x{piece.height}", ha="center", va="center", fontsize=8)
